...
<div class="w-10/12 px-10 mt-10">
    <div class="flex flex-row">
        <div class="bg-no-repeat bg-red-200 border border-red-300 rounded-xl w-7/12 mr-2 p-6"
            ...
            <span
                class="bg-red-300 text-xl text-white inline-block rounded-full mt-12 px-8 py-2"><strong>{{$DashBoardService->getTime()}}</strong></span>
        </div>
        ...
        <div class="bg-no-repeat bg-orange-200 border border-orange-300 rounded-xl w-5/12 ml-2 p-6"
            ...
            <p class="text-5xl text-indigo-900">Event Reqeusts <br><strong>{{$DashBoardService->AllEvents()}}</strong></p>
    ...
    <div class="flex flex-row h-64 mt-6">
        <div class="bg-blue-300 rounded-xl shadow-lg px-6 py-4 w-4/12">
            <div class="w-full rounded-[25px] bg-white p-8 aspect">
                ...
                <div class="my-2">
                    <h2 class="text-4xl font-bold"><span>{{$DashBoardService->AllUsers()}}</span></h2>
                </div>
        ...
        <div class="bg-green-300 rounded-xl shadow-lg mx-6 px-6 py-4 w-4/12">
            <div class="w-full rounded-[25px] bg-white p-8 aspect">
                ...
                <div class="my-2">
                    <h2 class="text-4xl font-bold"><span>{{$DashBoardService->AllComplaints()}}</span></h2>
                </div>

                <div>
                    <p class="mt-2 font-sans text-base font-medium text-gray-500">All Complaints</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-amber-200 rounded-xl shadow-lg px-6 py-4 w-4/12">
            <div class="w-full rounded-[25px] bg-white p-8 aspect">
                ...
                <div class="my-2">
                    <h2 class="text-4xl font-bold"><span>{{$DashBoardService->AllProcesses()}}</span></h2>
                </div>

                <div>
                    <p class="mt-2 font-sans text-base font-medium text-gray-500">All Procceses</p>
                </div>
            </div>
        </div>
    </div>
