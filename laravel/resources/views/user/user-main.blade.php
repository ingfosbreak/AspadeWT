...
<section class="bg-white dark:bg-gray-900">
    ...
    <div class="flex flex-col py-6 lg:mx-6">
        ...
        <button class="rounded-lg bg-white border border-black py-3 px-6 font-sans text-xs font-bold uppercase text-black shadow-md" data-ripple-light="true" style="position: absolute; bottom: 0; right: 5; top: 10;">
                White Button
            </button>

        <button class="rounded-lg bg-orange-500 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-orange-500/20 transition-all hover:shadow-lg hover:shadow-orange-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" data-ripple-light="true" style="position: absolute; bottom: 0; right: 0; top: 10;">
            Orange Button
        </button>
    </div>
</div>
