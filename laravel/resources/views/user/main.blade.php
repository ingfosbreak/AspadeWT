...
<div class="container mx-auto bg-gray-400 h-96 rounded-md flex items-center">
    <div class="sm:ml-20 text-gray-50 text-center sm:text-left">
        ...
        <p class="text-lg inline-block sm:block">The largest SUS community to rent saunas in Finland. {{$EventService->getAllEvent()}}</p>
...
<section class="bg-white ">
    ...
    <div class="container px-6 py-10 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-10 mt-8 md:mt-16 md:grid-cols-2">
            ...
            <div class="lg:flex wow"
                style="position: relative; visibility: visible; animation-delay: 0s; animation-name: fadeInUp;">
