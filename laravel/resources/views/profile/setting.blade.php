    ...
    <div class="h-full bg-gray-200 p-8">
        <div class="bg-white rounded-lg shadow-xl pb-8">
            ...
            <div class="flex flex-col items-center -mt-20">
                ...
                <img src="{{ asset('storage/'. Auth::getUser()->image->image_path) }}"
                ...
                <div class="flex items-center space-x-2 mt-2">
                    <p class="text-2xl">
                        {{Auth::getUser()->userFull->firstname ." ". Auth::getUser()->userFull->lastname}}</p>
                ...
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <ul class="mt-2 text-gray-700">
                        ...
                        <li class="flex border-y py-2">
                            ...
                            <span
                                class="text-gray-700">{{Auth::getUser()->userFull->firstname ." ". Auth::getUser()->userFull->lastname}}</span>
                        </li>
                        <li class="flex border-b py-2">
                    ...
                    @endif
                    <button data-modal-target="information-modal" data-modal-toggle="information-modal"
                        class="mt-5 mb-5 block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        type="button">
                        Edit information
                    </button>
                </div>
            ...
            <div class="flex flex-col w-full h-content 2xl:w-2/3">
                <div class="flex-1 flex-col bg-white rounded-lg shadow-xl p-8">
                    ...
                    <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                        class="mt-5 mb-5 bg-red-700 rounded-lg w-40">
                        <h4 class="text-xl text-white font-bold">Logout</h4>
                    </button>
                    ...
                    <form action="{{route('change.password')}}" class="space-y-6" method="POST">
                        ...
                        <div>
                            <label for="newpassword"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your new
                                password</label>
        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form action="{{route('edit.image')}}" class="space-y-6" method="POST"
